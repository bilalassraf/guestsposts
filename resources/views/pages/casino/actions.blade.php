...
<a href="javascript:void(0);" class="edit" onclick="sendAjaxRequest('{{ route('admin.casino.request.blackhat', $request->id) }}', {{ $request->id }});">    
  <i class="material-icons fas fa-hat-cowboy text-dark" title="Bad Request"></i>
</a>
<a href="javascript:void(0);" onclick="sendAjaxRequest('{{ route('admin.single.casino.request.spam', $request->id) }}', {{ $request->id }});" class="edit">    
