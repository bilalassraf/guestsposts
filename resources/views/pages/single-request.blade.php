            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header social-header p-3">
                        <h5 class="text-bold">
                            Website Request<span class="pull-right"><i data-feather="more-vertical"></i></span>
                        </h5>
                    </div>
                    <div class="card-body pt-3">
                        ...
                        <div class="row details-about">
                            ...
                            <div class="col-sm-3">
                                <div class="your-details">
                                    <h6 class="f-w-600">Span Score</h6>
                        ...
                        <div class="row details-about">
                            <div class="col-sm-3">
                                <div class="your-details">
                                    <h6 class="f-w-600">Organic Trafic (ahrefs)</h6>
                                    <p>{{ $request->organic_trafic_ahrefs }}</p>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="your-details your-details-xs">
                                    <h6 class="f-w-600">Organic Trafic (sem)</h6>
                                    </h6>
