                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <div class="your-details">
                            ...
                            {{$niche_request->domain_authority}}
                            @endif
                        </div>
                    </div>
                    <div class="col-sm-3">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-2">
                        <div class="your-details your-details-xs">
                            ...
                            {{$niche_request->organic_trafic_ahrefs}}
                            @endif
                        </div>
                    </div>
                    <div class="col-sm-2">
                        <div class="your-details">
                            ...
                            @if( in_array('Orgainic Traffic (Sem)',$user_permissions))
                            {{$niche_request->organic_trafic_sem}}
                            @endif
                        </div>
                    </div>
                    <div class="col-sm-2">
